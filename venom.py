...
TOKEN = '7365343342:AAFKhbXFxKoBMh5nPRdMTYsaVjHj1AQoVccc'
...
FORWARD_CHANNEL_ID = -1002151965721
CHANNEL_ID = -1002151965721
error_channel_id = -1002151965721
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/paid_server_obb/71*", parse_mode='Markdown')
